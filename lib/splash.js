...
export default function splash ({ path, name, org, coc, logo, active, total, channels, large, iframe }){
  let div = dom('.splash',
    ...
    dom('p',
      "We're experimenting with using Slack for conference-wide communication before, during and after the conference.  Each Slack account shows the email associated with it.  If you want to join the conference Slack with the email that you're OK with to be visible to all other conference attendees who will use Slack.  Please do not use the emails for data collection, any mass-mailing, or for the purposes unrelated to the conference.  This is an experimental communication channel and as such is optional and comes without SLAs of any kind.  You do not need Slack at all for any real-life conference experiences.  If you have problems connecting with Slack, we'll announce how to find the volunteers who can help."
    ),
    dom('p.status',
      active
        ? [
